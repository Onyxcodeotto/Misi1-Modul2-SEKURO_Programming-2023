...
int main() {
    ...
    printf("Jawaban:\n");
    printf("short, int, long, char, double, float\n"); // lengkapi di sini. jawaban tidak dibatasi dalam 1 baris

    /* Nomor 2 [5 point] */
    printf("2. Sebutkan perbedaan fungsi dan prosedur!\n");
    printf("Jawaban:\n");
    printf("Fungsi mengembalikan suatu nilai, sedangkan prosedur tidak mengembalikan nilai. Jika ingin dibuat prosedur yang mengubah nilai, perubahan nilai terjadi di dalam prosedur.\n"); // lengkapi di sini. jawaban tidak dibatasi dalam 1 baris
